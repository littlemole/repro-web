...
<html>
<head>
<title>Hello Websockets Login</title>
<meta charset="UTF-8">
...
<div class="frame">
<div class="title">
    <h1>hello websockets login</h1>
    <p>hello world websocket login example for modern reactive c++ for the web.</p>
</div>
</div>
...
<!-- Navigation Bar -->
  ...
  <div class="main">
      <h2>Hello WebSockets Example Login</h2>
