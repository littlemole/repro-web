...
<html>
<head>
<title>Hello Websockets Registration</title>
<meta charset="UTF-8">
...
<div class="header">
  ...
  <a href="https://github.com/littlemole/repro-web/tree/master/example/hello_ws">this example</a>
</div>

<div class="frame">
<div class="title">
    <h1>hello websockets registration</h1>
    <p>hello world websocket example registrationfor modern reactive c++ for the web.</p>
</div>
</div>
...
<!-- Navigation Bar -->
  ...
  <div class="main">
      <h2>Hello WebSockets Registration Example</h2>
